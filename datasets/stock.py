...
class Stock():
    ...
    def __init__(self, ts_code, si=None, start_date=None, end_date=None):
        ...
        logging.debug(f"Stock::__init__() - start_date:{start_date}({type(start_date)}), end_date:{end_date}")
        ...
        logging.debug(f"Stock::__init__() - ts_code:{ts_code}, start_date:{self.start_date}({type(self.start_date)}), end_date:{self.end_date}")
        ...
        logging.debug(f"done! self.start_date:{self.start_date}, self.end_date:{self.end_date}, data shape:{self.df_filtered.shape}, head/tail:\n{self.df_filtered.head(3)}{self.df_filtered.tail(3)}")
