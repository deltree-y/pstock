...
class Trade():
    ...
    def drop_features_by_type(self, stock_type):
        if stock_type == StockType.PRIMARY or stock_type == StockType.RELATED:
            ...
            t1l10_features_35 = ["volatility_5d","natr_14","macd_signal","y5","dv_ratio","willr_14","1w","date_full","cmt","vol","w26_bd","y30_us_trycr","pb","m1","y1","y10","on","w52_bd","close_to_high_20d","DMP_14","w4_ce","6m","w52_ce","close_vs_low","amplitude","w26_ce","y5_us_trycr","pe","ps","volatility_10d","y20","close_vs_open","turnover_rate_f","roc_10","total_mv"]
            t1l10_features_55 = ["volatility_5d","natr_14","macd_signal","y5","dv_ratio","willr_14","1w","date_full","cmt","vol","w26_bd","y30_us_trycr","pb","m1","y1","y10","on","w52_bd","close_to_high_20d","DMP_14","w4_ce","6m","w52_ce","close_vs_low","amplitude","w26_ce","y5_us_trycr","pe","ps","volatility_10d","y20","close_vs_open","turnover_rate_f","roc_10","total_mv","y10_us_trycr","atr_14","macd_hist","ADX_14","return_5d","open","obv","close","ltc","w4_bd","BBB_20_2.0","ltr_avg","1y","y30","return_10d","stddev_10"]
