...
class Trade():
    ...
    def drop_features_by_type(self, stock_type):
        if stock_type == StockType.PRIMARY or stock_type == StockType.RELATED:
            #皮尔逊+互信息+树模型交集特征
            basic_features = ['ts_code', 'trade_date', 'open', 'high', 'low', 'close', 'industry_idx', 'stock_idx', 'date_full']
            ...
            extra_features_34 = ['macd_signal', 'cci_20', 'willr_14', 'stddev_10', 'date_full', 'obv', 'pe', 'cmf_20', 'dv_ratio', 'natr_14', 'volatility_10d', 'momentum_10', 'turnover_rate_f', 'pb', 'mfi_14', 'ps', 'BBP_20_2.0', 'rsi_14', 'stock_idx', 'macd_hist', 'volatility_5d', 'DMN_14', 'STOCHd_3_3_3', 'change', 'macd', 'ADX_14', 'DMP_14', 'total_mv', 'atr_14', 'BBB_20_2.0', 'return_5d', 'amount', 'return_10d', 'roc_10']
            extra_features_40 = ['natr_14', 'w26_ce', 'pb', 'y10_us_trycr', 'pe', 'price_volume_ratio', 'pct_chg', 'y30_us_trycr', 'industry_idx', 'total_mv', 'turnover_rate_f', '1w', 'macd', 'obv', 'y1', 'return_1d', 'volatility_10d', 'return_5d', 'y30', 'stock_idx', '1y', 'dv_ratio', 'BBB_20_2.0', 'willr_14', 'm1', 'log_return', 'date_full', 'y5_us_trycr', 'y5', 'on', 'y10', 'stddev_10', 'ltr_avg', 'macd_signal', 'volatility_5d', 'atr_14', 'return_10d', '6m', 'roc_10', 'ps']

            extra_features_15 = ['natr_14', 'volatility_10d', 'BBB_20_2.0', 'volatility_5d', 'dv_ratio', 'date_full', '1y', 'turnover_rate_f', '6m', 'cmt', 'y20', 'ltc', 'y1', 'pb', 'y30']
            extra_features_20 = ['natr_14', 'volatility_10d', 'BBB_20_2.0', 'volatility_5d', 'dv_ratio', 'date_full', '1y', 'turnover_rate_f', '6m', 'cmt', 'y20', 'ltc', 'y1', 'pb', 'y30', 'w52_ce', 'w26_bd', 'y30_us_trycr', 'y10', 'y10_us_trycr']
            extra_features_25 = ['natr_14', 'volatility_10d', 'BBB_20_2.0', 'volatility_5d', 'dv_ratio', 'date_full', '1y', 'turnover_rate_f', '6m', 'cmt', 'y20', 'ltc', 'y1', 'pb', 'y30', 'w52_ce', 'w26_bd', 'y30_us_trycr', 'y10', 'y10_us_trycr', 'w26_ce']
            extra_features_30 = ['natr_14', 'volatility_10d', 'BBB_20_2.0', 'volatility_5d', 'dv_ratio', 'date_full', '1y', 'turnover_rate_f', '6m', 'cmt', 'y20', 'ltc', 'y1', 'pb', 'y30', 'w52_ce', 'w26_bd', 'y30_us_trycr', 'y10', 'y10_us_trycr', 'w26_ce', 'ltr_avg', 'w52_bd', 'y5_us_trycr', 'y5', '1w']
            ...
            remain_list = list(dict.fromkeys(chain(basic_features, extra_features_30, advanced_features)))    #取并集
    ...
    def update_t1_change_rate(self):#表示T1低值的变化率
        ...
        if self.trade_count < 2:
            ...
            return
        self.__t1_change_rate = (self.__raw_data_pure_np[:-1, self.col_low] - self.__raw_data_pure_np[1:, self.col_close]) / self.__raw_data_pure_np[1:, self.col_close] \
    ...
    def update_t2_change_rate(self):#表示T2高值的变化率
        ...
        if self.trade_count < 3:
            ...
            return
        self.__t2_change_rate = (self.__raw_data_pure_np[:-2, self.col_high] - self.__raw_data_pure_np[2:, self.col_close]) / self.__raw_data_pure_np[2:, self.col_close] \
