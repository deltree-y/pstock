...
class Trade():
    ...
    def drop_features_by_type(self, stock_type):
        if stock_type == StockType.PRIMARY or stock_type == StockType.RELATED:
            ...
            extra_features_19 = ['natr_14', 'volatility_10d', 'BBB_20_2.0', 'volatility_5d', 'dv_ratio',  'turnover_rate_f', 'total_mv', 'pb', 'pe', 'atr_14', 'ADX_14', 'ps', 'stddev_10', 'DMP_14', 'roc_10', 'return_10d', 'stock_idx', 'return_5d', 'rsi_14']
            extra_features_24 = ['natr_14', 'volatility_10d', 'date_full', 'BBB_20_2.0', 'volatility_5d', 'dv_ratio', 'turnover_rate_f', 'total_mv', 'pb', 'pe', 'atr_14', 'ADX_14', 'ps', 'stddev_10', 'DMP_14', 'roc_10', 'return_10d', 'return_5d', 'rsi_14', 'willr_14', 'cci_20', 'cmf_20', 'obv', 'mfi_14']
            extra_features_32 = ['macd_signal', 'cci_20', 'willr_14', 'stddev_10', 'obv', 'pe', 'cmf_20', 'dv_ratio', 'natr_14', 'volatility_10d', 'momentum_10', 'turnover_rate_f', 'pb', 'mfi_14', 'ps', 'BBP_20_2.0', 'rsi_14', 'macd_hist', 'volatility_5d', 'DMN_14', 'STOCHd_3_3_3', 'change', 'macd', 'ADX_14', 'DMP_14', 'total_mv', 'atr_14', 'BBB_20_2.0', 'return_5d', 'amount', 'return_10d', 'roc_10']
            extra_features_37 = ['natr_14', 'w26_ce', 'pb', 'y10_us_trycr', 'pe', 'price_volume_ratio', 'pct_chg', 'y30_us_trycr', 'total_mv', 'turnover_rate_f', '1w', 'macd', 'obv', 'y1', 'return_1d', 'volatility_10d', 'return_5d', 'y30', '1y', 'dv_ratio', 'BBB_20_2.0', 'willr_14', 'm1', 'log_return', 'y5_us_trycr', 'y5', 'on', 'y10', 'stddev_10', 'ltr_avg', 'macd_signal', 'volatility_5d', 'atr_14', 'return_10d', '6m', 'roc_10', 'ps']

            extra_features_15 = ['natr_14', 'volatility_10d', 'BBB_20_2.0', 'volatility_5d', 'dv_ratio', '1y', 'turnover_rate_f', '6m', 'cmt', 'y20', 'ltc', 'y1', 'pb', 'y30']
            extra_features_20 = ['natr_14', 'volatility_10d', 'BBB_20_2.0', 'volatility_5d', 'dv_ratio', '1y', 'turnover_rate_f', '6m', 'cmt', 'y20', 'ltc', 'y1', 'pb', 'y30', 'w52_ce', 'w26_bd', 'y30_us_trycr', 'y10', 'y10_us_trycr']
            extra_features_25 = ['natr_14', 'volatility_10d', 'BBB_20_2.0', 'volatility_5d', 'dv_ratio', '1y', 'turnover_rate_f', '6m', 'cmt', 'y20', 'ltc', 'y1', 'pb', 'y30', 'w52_ce', 'w26_bd', 'y30_us_trycr', 'y10', 'y10_us_trycr', 'w26_ce']
            extra_features_30 = ['natr_14', 'volatility_10d', 'BBB_20_2.0', 'volatility_5d', 'dv_ratio', '1y', 'turnover_rate_f', '6m', 'cmt', 'y20', 'ltc', 'y1', 'pb', 'y30', 'w52_ce', 'w26_bd', 'y30_us_trycr', 'y10', 'y10_us_trycr', 'w26_ce', 'ltr_avg', 'w52_bd', 'y5_us_trycr', 'y5', '1w']
            ...
            t2h_extra_features_25 = ['e_factor', 'natr_14', 'date_full', 'macd_cross', 'vol_max_5d', 'volatility_10d', 'amplitude', 'dv_ratio', 'BBB_20_2.0', '1y', 'on', 'vol_max_10d', '6m', 'volatility_5d', '1w', 'vol_max_20d', 'total_mv', 'close_to_high_20d', 'pe', 'w52_bd', 'turnover_rate_f', 'y1', 'pb', 'w52_ce', 'y10']
            t2h_extra_features_35 = ['e_factor', 'natr_14', 'date_full', 'macd_cross', 'vol_max_5d', 'volatility_10d', 'amplitude', 'dv_ratio', 'BBB_20_2.0', '1y', 'on', 'vol_max_10d', '6m', 'volatility_5d', '1w', 'vol_max_20d', 'total_mv', 'close_to_high_20d', 'pe', 'w52_bd', 'turnover_rate_f', 'y1', 'pb', 'w52_ce', 'y10', 'y5', 'w26_bd', 'w26_ce', 'y5_us_trycr', 'ltc', 'y20', 'cmt', 'y30', 'w4_bd', 'w4_ce']
            t2h_extra_features_45 = ['e_factor', 'natr_14', 'date_full', 'macd_cross', 'vol_max_5d', 'volatility_10d', 'amplitude', 'dv_ratio', 'BBB_20_2.0', '1y', 'on', 'vol_max_10d', '6m', 'volatility_5d', '1w', 'vol_max_20d', 'total_mv', 'close_to_high_20d', 'pe', 'w52_bd', 'turnover_rate_f', 'y1', 'pb', 'w52_ce', 'y10', 'y5', 'w26_bd', 'w26_ce', 'y5_us_trycr', 'ltc', 'y20', 'cmt', 'y30', 'w4_bd', 'w4_ce', 'm1', 'y10_us_trycr', 'log_volume', 'y30_us_trycr', 'ltr_avg', 'atr_14', 'stock_idx', 'rsi_14', 'weekday', 'stddev_10']
